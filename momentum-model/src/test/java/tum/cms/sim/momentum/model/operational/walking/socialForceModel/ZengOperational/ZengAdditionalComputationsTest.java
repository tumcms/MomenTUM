...
public class ZengAdditionalComputationsTest {
    ...
    public void calculateTimeToConflictPoint() throws Exception {
        ...
        Assert.assertEquals(0.0, ZengAdditionalComputations.calculateTimeToConflictPoint(curPosition, curVelocity,
        ...
        othVelocity = GeometryFactory.createVector(-1, -1);
        Assert.assertEquals(Double.POSITIVE_INFINITY, ZengAdditionalComputations.calculateTimeToConflictPoint(curPosition, curVelocity,
                othPosition, othVelocity), PRECISION);
        ...
        Assert.assertEquals(10.0, ZengAdditionalComputations.calculateTimeToConflictPoint(curPosition, curVelocity,
                othPosition, othVelocity), PRECISION);
